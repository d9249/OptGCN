...
class MixGCF_Egress(GraphRecommender):
    def __init__(self, conf, training_set, test_set):
        super(MixGCF_Egress, self).__init__(conf, training_set, test_set)
        args = OptionConf(self.config['MixGCF_Egress'])
    ...
    def save(self):
        save_path = "./embedding/Egress/MixGCF_Egress/"
        with torch.no_grad():
