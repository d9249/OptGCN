...
class NCL_Egress(GraphRecommender):
    def __init__(self, conf, training_set, test_set):
        super(NCL_Egress, self).__init__(conf, training_set, test_set)
        args = OptionConf(self.config['NCL_Egress'])
    ...
    def save(self):
        save_path = "./embedding/Egress/NCL_Egress/"
        with torch.no_grad():
