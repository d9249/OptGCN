...
class SGL_Egress(GraphRecommender):
    def __init__(self, conf, training_set, test_set):
        super(SGL_Egress, self).__init__(conf, training_set, test_set)
        args = OptionConf(self.config['SGL_Egress'])
    ...
    def save(self):
        save_path = "./embedding/Egress/SGL_Egress/"
        with torch.no_grad():
